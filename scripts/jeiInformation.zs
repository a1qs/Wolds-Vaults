...
mods.jei.JEI.addDescription(<item:the_vault:vault_catalyst_fragment>,("Catalyst Fragments can be found inside Gilded Chests in Vaults starting at Level 24."));
mods.jei.JEI.addDescription(<item:the_vault:augment>,("Combining a Vault Crystal with an Augment in a Crystal Workbench will guarantee the theme that is specified on the Augment. Augments have a 20% chance to be awarded in a Completion crate and will be set to the theme of the Vault that it was obtained from."));
...
mods.jei.JEI.addDescription(<item:the_vault:soul_flame>,("Put this Vault Rock on a Vault Altar to create your Challenger's Crystal, doing so adds Ascension to your crystal. When your Ascension run comes to an end you will get Embers which you can use in the Ascension Forge to purchase items and transmogrifications"));
...
mods.jei.JEI.addDescription(<item:the_vault:eye_of_avarice>,("Apply to a crystal in an anvil to add Looters Dream. Looters Dream completely negates all trapped chances from ever occurring even when on a crystal with the Trapped Modifier."));
